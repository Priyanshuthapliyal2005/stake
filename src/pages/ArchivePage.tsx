...
import { Clock, Users, MessageCircle, TrendingUp, Search, Filter, FileText } from 'lucide-react';
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Explore ongoing debates or dive into our archive of completed discussions with AI-powered summaries
            </p>
          </motion.div>
        </div>
              ...
              >
                ...
                <Link
                  to={
                    ...
                    room.status === 'active' ? `/room/${room.id}/live` : 
